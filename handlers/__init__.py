...
from handlers.start import help_command, log_command_update, ping_command, start_command, unknown_command
...
def register_handlers(application: Application) -> None:
    ...
    application.add_handler(MessageHandler(filters.COMMAND, log_command_update), group=-1)
